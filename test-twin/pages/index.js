      ...
      <main className="flex-1 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl font-semibold text-white md:text-7xl mb-8">
              Find Your{' '}
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed" style={{fontWeight: '400'}}>
              Are you struggling to stay on track with your LSAT or MCAT study plan? Has procrastination taken over your prep journey?
            </p>
            
            <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed" style={{fontWeight: '400'}}>
              We understand that staying disciplined can be tough when you're doing it alone. That's why we've created TestTwin, 
              a revolutionary platform that pairs you with a like-minded study buddy to keep you accountable and on track. 
              With TestTwin, you'll find your perfect study match—your academic twin who echoes your aspirations, 
              syncs with your schedule, and amplifies your motivation to conquer procrastination.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm p-8 rounded-2xl hover:shadow-xl transition-all duration-300" style={{border: '2px solid #c8a8e9'}}>
              ...
              <h3 className="text-xl mb-4 text-white" style={{fontWeight: '500'}}>Made by Students, for Students</h3>
